...
class AC():
    ...
    def __init_net(self):
        ...
        self.critic.add(Dense(50, input_dim=self.states_n, activation='relu', kernel_initializer=weight_init, bias_initializer=bias_init))
...
if __name__ == '__main__':
    ...
    env = env.unwrapped
    RL = AC(env.action_space.low, env.action_space.high, env.observation_space.shape[0], 0.0015, 0.01)
    ...
    while True:
        ...
        loss = RL.learn(state, action, reward, next_state)
        state = next_state
